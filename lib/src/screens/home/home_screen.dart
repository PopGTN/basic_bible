...
//   // Combine tabs, titles, and icons in one list
//   final _tabItems = [
...
//     return SafeArea(
//       child: Scaffold(
//         appBar: AppBar(title: Text(currentTab['title'] as String)),
//         body: isWideScreen
//             ? Row(
//                 children: [
//                   NavigationRail(
...
//                 ],
//               )
//             : _tabItems[_currentIndex]['widget'] as Widget,
