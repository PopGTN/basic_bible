...
class ChapterBar extends ConsumerWidget {
  const ChapterBar({
    super.key,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          FilledButton.tonal(
            onPressed: () {
              // Example: you could use ref.read(chapterProvider.notifier).previous();
          ...
          Expanded(
            child: FilledButton.tonal(
              ...
              child: const Text(
                "Genesis 1", // ← in future you can pull this from a provider
          ...
          FilledButton.tonal(
            onPressed: () {
              // Example: you could use ref.read(chapterProvider.notifier).next();
              print("Next chapter");
            },
            style: FilledButton.styleFrom(
              shape: const RoundedRectangleBorder(
